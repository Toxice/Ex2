 ...
 * Each spreadsheet entry (aka a Util.Cell) which can be:
 ...
 *  */
     ...
     * @return an int value (as defined in Util.Ex2Utils)
     */
    public int getType();

    /**
     * Changes the type of this Util.Cell {TEXT,NUMBER, FORM, ERR_CYCLE_FORM, ERR_WRONG_FORM}
    ...
    public int getOrder();
    /**
     * Changes the order of this Util.Cell
     * @param t
     */
