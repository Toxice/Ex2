 ...
 */
/******************************************************************************
 *  Compilation:  javac Util.StdDrawEx2.java
 *  Execution:    java Util.StdDrawEx2
 *  Dependencies: none
 *
 *
...
/**
 *  The {@code Util.StdDrawEx2} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code Util.StdDrawEx2.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">Util.StdDrawEx2.java</a>
 ...
 *           Util.StdDrawEx2.setPenRadius(0.05);
 *           Util.StdDrawEx2.setPenColor(Util.StdDrawEx2.BLUE);
 *           Util.StdDrawEx2.point(0.5, 0.5);
 *           Util.StdDrawEx2.setPenColor(Util.StdDrawEx2.MAGENTA);
 *           Util.StdDrawEx2.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code Util.StdDrawEx2.line()} and {@code Util.StdDrawEx2.point()}
 *  draw lines and points; the methods {@code Util.StdDrawEx2.setPenRadius()}
 *  and {@code Util.StdDrawEx2.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code Util.StdDrawEx2.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   Util.StdDrawEx2.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code Util.StdDrawEx2.setPenRadius(0.025)} makes
 ...
 *  For example, {@code Util.StdDrawEx2.setPenColor(Util.StdDrawEx2.MAGENTA)} sets the
 ...
 *  For example, {@code Util.StdDrawEx2.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code Util.StdDrawEx2.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   Util.StdDrawEx2.setFont(font);
 *   Util.StdDrawEx2.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code Util.StdDrawEx2.clear(Util.StdDrawEx2.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   Util.StdDrawEx2.setScale(-2, +2);
 *   Util.StdDrawEx2.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       Util.StdDrawEx2.clear();
 *       Util.StdDrawEx2.filledCircle(x, y, 0.05);
 *       Util.StdDrawEx2.filledCircle(-x, -y, 0.05);
 *       Util.StdDrawEx2.show();
 *       Util.StdDrawEx2.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDrawEx2 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * {@code Util.StdDrawEx2.BLACK}, {@code Util.StdDrawEx2.BLUE}, {@code Util.StdDrawEx2.CYAN},
	 * {@code Util.StdDrawEx2.DARK_GRAY}, {@code Util.StdDrawEx2.GRAY}, {@code Util.StdDrawEx2.GREEN},
	 * {@code Util.StdDrawEx2.LIGHT_GRAY}, {@code Util.StdDrawEx2.MAGENTA}, {@code Util.StdDrawEx2.ORANGE},
	 * {@code Util.StdDrawEx2.PINK}, {@code Util.StdDrawEx2.RED}, {@code Util.StdDrawEx2.WHITE}, and
	 * {@code Util.StdDrawEx2.YELLOW}.
	 *
	...
	private static Image getImage(String filename) {
		...
		// in case file is inside a .jar (classpath relative to Util.StdDrawEx2)
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
    ...
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Util.StdDrawEx2)
        try {
            URL url = Util.StdDrawEx2.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
	...
	public static String getCell(Index2D cord, String input) {
		var ans = JOptionPane.showInputDialog("Util.Cell: "+cord+"= "+input,input);
		var output = ans + " FORM!";
		return ans;
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		//j.setText("Enter");
		//j.setVisible(true);
	/*	FileDialog chooser = new FileDialog(Util.StdDrawEx2.frame, "Enter text to ("+ix+","+iy+")", FileDialog.SAVE);
		chooser.setVisible(true);
		String filename = chooser.getFile();
		if (filename != null) {
			Util.StdDrawEx2.save(chooser.getDirectory() + File.separator + chooser.getFile());
		}*/
	}
